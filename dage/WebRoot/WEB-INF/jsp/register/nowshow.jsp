...
<html>
  <head>
    ...
    <script type="text/javascript" src="easyui/validator.js"></script></head>
  
  <body>
    <table id="tt" class="easyui-datagrid" title="当前入住信息统计" style="width:100%;height:100%"
		toolbar="#tb" fitColumns="true" pagination="true" data-options="singleSelect:true,collapsible:true,url:'nowregister/list.do',method:'get'">
		<thead>
			<tr>
				...
				<th data-options="field:'cash',width:80,align:'center'">押金</th>
			</tr>
		</thead>
	</table>  
			...
			<div class="fitem">
				<table>
					...
					<tr>
						...
						<td><input type="text"  class="easyui-validatebox" name="cusname" style="width:200px" required="required"></td>
					</tr>
					<tr>
						<td><label>性别:</label></td>
						<td><input type="text"  class="easyui-validatebox" name="cussex" style="width:200px" required="required"></td>
					</tr>
					<tr>
						<td><label>手机号:</label></td>
						<td><input name="custel" class="easyui-validatebox" style="width:200px" validType="PhoneOrMobile"></td>
					</tr>
					<tr>
						<td><label>证件类型:</label></td>
						<td><input name="idcardtype" class="easyui-validatebox" style="width:200px" required="required"></td>
					</tr>
					<tr>
						<td><label>证件号:</label></td>
						<td><input name="idcard" class="easyui-validatebox" style="width:200px"  validType="idcard"></td>
					</tr>
					<tr>
	...
	<div id="dlg-buttons">
		<a class="easyui-linkbutton" iconCls="icon-ok" onclick="saveCus()">Save</a>
