		...
		closed="true"  buttons="#dlg-buttons">
			<form id="fm" method="post">
				...
				<div class="fitem" style="padding:3px 20px">
					...
					<input name="deptname" class="easyui-validatebox" required="true"  validType='deptname' id="dna">
				</div>
				<div class="fitem" style="padding:3px 20px">
					<label style="letter-spacing:1px;">部门介绍:</label>
					<textarea required="true"  rows="3" cols="14" style="vertical-align:top;" name="deptlim" class="easyui-validatebox" >
					</textarea>
				</div>
				<div class="fitem" style="padding:3px 20px">
