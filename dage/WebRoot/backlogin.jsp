...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="emptel" id="emptel" value="" placeholder="请输入用户名" />
						</div>
					</div>
				</div>
				<div class="control-group">
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">2018-2118 &nbsp;&nbsp;&nbsp;&nbsp; 版权©  2018年 QY88第十一组版权所有</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = emptel+","+password+","+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login.do',
			    	data: {emptel:emptel,password:password},
			    	dataType:'text',
		...
		function check() {
			...
			if ($("#emptel").val() == "") {
				...
				$("#emptel").val(jQuery.trim($('#emptel').val()));
			}
			if ($("#password").val() == "") {
				$("#password").tips({
					side : 2,
		...
		jQuery(function() {
			var emptel = $.cookie('emptel');
			var password = $.cookie('password');
			if (typeof(emptel) != "undefined"
