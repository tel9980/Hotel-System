...
},beforePageText:"第",afterPageText:"页，共{pages}页",displayMsg:"共{total}条数据，当前显示 {from} 至 {to} 条数据",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"该项为必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_534,blur:_538,mouseenter:_53b,mouseleave:_53e,click:function(e){
var t=$(e.data.target);
