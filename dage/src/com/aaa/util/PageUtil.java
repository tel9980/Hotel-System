...
public class PageUtil {
	...
	/*public static void main(String[] args) {
		String url  = "/web20180918/jsp/page/page3.jsp?dname=内";
		System.out.println(url.charAt(url.length()-1));//charAt返回某一个字符串中什么位置上的字符   url.charAt(url.length()-1) 去url最后一个字符
